...
import com.function.graphql.ReservasGraphQLProvider;
...
public class ReservasGraphQLFunction {

    private static final ObjectMapper MAPPER = new ObjectMapper();

    @FunctionName("graphqlReservas")
    public HttpResponseMessage execute(
        ...
        context.getLogger().info("GraphQL request recibido en reservas-graphql-function");
        ...
        try {
            ...
            ExecutionResult result = ReservasGraphQLProvider.get().execute(input);
            ...
            context.getLogger().severe("Error en GraphQL reservas: " + e.getMessage());
